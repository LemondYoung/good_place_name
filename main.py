...
# 预设一些主题（更好听一些）
theme_list = {
    'fruit_animal': [fruit_adj, animal_stuff],  # 水果动物主题，比如桃马公园，栗鼠公园，芒鸟公园
    'plant_animal': [plant_adj, animal_stuff],  # 植物动物主题，比如茶马乐园，竹鼠乐园，瑰鱼乐园，麦龙乐园
...
if __name__ == '__main__':
    # 根据主题生成并打印随机地名
    selected_theme = random.choice(accept_theme_list)  # 在这里选择主题，请从accept_theme_list列表中选择，如果None代表随机
    place = None  # 如果空代表随机
    result = batch_generate_name(theme=selected_theme, place=place, count=50)
